...
<body style="background-image: url('https://w0.peakpx.com/wallpaper/755/269/HD-wallpaper-furniture.jpg'); background-size: cover;">
    <nav class="navbar navbar-expand-lg py-3 navbar-dark bg-dark shadow-sm">
    <div class="container">
        <div class="navbar-brand">
            <img src="images/logov2.png" width="55" alt="" class="d-inline-block align-middle mr-2">
            <span aling = "center" style = "font-size: 40px;"class="text-uppercase font-weight-bold">Venta de Muebles</span>
        </div>
    </div>
